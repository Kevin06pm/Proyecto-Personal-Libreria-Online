...
<style>
    ...
    /* setilos CSS para el botón de pagar */
    .pay-button {
        text-align: center;
        margin-top: 20px;
    }
...
<section class="event">
    ...
    <div class="contenedor">
        ...
        <div class="flex-wrapper" style="padding-top: 6%">
        ...
        <ul class="books-list has-scrollbar" style="border-radius: 1em; border: 10px solid gold; padding: 2% 2% 2% 2%;">
                @if(Cart::count())     
            ...
            <div class="payment-container">
                ...
                <button id="btn-pagar" type="button" class="btn btn-success" data-toggle="modal" data-target="#checkoutModal" style="margin-top:10px">
                    Pagar
                </button>

                @include('biblioteca.partials.msgpagar') <!--mensajes modales si esta o no registrado-->
